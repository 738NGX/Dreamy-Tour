...
declare global {
  interface IAppOption {
    ...
    //getWalkDirections(origin: Location, destination: Location, startDate: number, strategy: number): Promise<{ duration: number[], distance: number[], amount: number[], route: Transportation[] }>;
