...
-- 频道表 channels
INSERT INTO channels (name, description, masterId, adminIds, status, humanCount, level, createdAt, updatedAt) VALUES
  ('世界频道', '大家一起实现梦想的公共频道', 1, '1', 0, 1, -1, 1741509435699, 1741509435699),
  ('Aqours远征群', '爱生活! 艳阳天!', 2, '2', 0, 1, 0, 1741509435699, 1741509435699),
  ('上财辣辣人同好会', 'みんなで叶える物語', 5, '5', 0, 1, 1, 1741509435699, 1741509435699),
  ('川藏线自驾联盟', 'G318国道自驾攻略分享', 7, '7', 0, 1, 0, 1741509435700, 1741509435700),
  ('东南亚潜水小队', '仙本那/斯米兰潜水约伴', 12, '12', 0, 1, 1, 1741509435701, 1741509435701),
  ('古镇漫游者', '江南六大古镇打卡指南', 18, '18', 0, 1, 2, 1741509435702, 1741509435702),
  ('雪山攀登计划', '哈巴/玉珠峰攀登组队', 23, '23', 0, 1, 0, 1741509435703, 1741509435703),
  ('环球背包客', '青旅拼房&长途路线规划', 31, '31', 0, 1, 1, 1741509435704, 1741509435704),
  ('美食地图挖掘','『米其林vs街头小吃评测』', 9, '9', 0, 1, 2, 1741509435705, 1741509435705),
  ('房车旅行之家', '营地信息共享&车辆改装', 15, '15', 0, 1, 0, 1741509435706, 1741509435706),
  ('极光追猎者', '冰岛/挪威极光观测团', 28, '28', 0, 1, 1, 1741509435707, 1741509435707),
  ('亲子露营公社', '江浙沪优质营地推荐', 40, '40', 0, 1, 2, 1741509435708, 1741509435708),
  ('非遗文化之旅', '传统手工艺体验路线', 6, '6', 0, 1, 0, 1741509435709, 1741509435709),
  ('徒步中国', '十大经典徒步路线约伴', 14, '14', 0, 1, 1, 1741509435710, 1741509435710),
  ('海岛控集合', '马尔代夫选岛指南', 27, '27', 1, 1, 2, 1741509435711, 1741509435711),
  ('摄影旅拍小队', '无人机航拍技巧交流', 33, '33', 0, 1, 0, 1741509435712, 1741509435712),
  ('大学生穷游组', '火车硬座特种兵攻略', 8, '8', 0, 1, 1, 1741509435713, 1741509435713),
  ('滑雪搭子速配', '北海道粉雪季组队', 19, '19', 0, 1, 2, 1741509435714, 1741509435714),
  ('古迹探秘者', '世界遗产巡礼路线', 25, '25', 0, 1, 0, 1741509435715, 1741509435715),
  ('自驾丝绸之路', '河西走廊历史穿越之旅', 36, '36', 0, 1, 1, 1741509435716, 1741509435716),
  ('骑行318', '成都到拉萨装备清单', 4, '4', 0, 1, 2, 1741509435717, 1741509435717),
  ('旅居办公联盟', '数字游民签证政策解读', 11, '11', 0, 1, 0, 1741509435718, 1741509435718),
  ('秘境探险组', '穿越丙察察路线实况', 22, '22', 0, 1, 1, 1741509435719, 1741509435719),
  ('邮轮旅行指南', '地中海航线比价分析', 30, '30', 0, 1, 2, 1741509435720, 1741509435720),
  ('候鸟养老旅居', '三亚vs西双版纳过冬', 38, '38', 0, 1, 0, 1741509435721, 1741509435721),
  ('星空摄影团', '纳米比亚暗夜保护区', 17, '17', 0, 1, 1, 1741509435722, 1741509435722),
  ('签证互助社', '申根签slot抢约攻略', 3, '3', 0, 1, 2, 1741509435723, 1741509435723),
  ('民宿体验官', '网红民宿试睡报告', 10, '10', 0, 1, 0, 1741509435724, 1741509435724),
  ('朝圣之路', '西班牙圣地亚哥徒步', 24, '24', 0, 1, 1, 1741509435725, 1741509435725),
  ('公路咖啡馆', '318国道精品咖啡馆地图', 29, '29', 0, 1, 2, 1741509435726, 1741509435726),
  ('旅伴匹配中心', '性格测试找合拍旅友', 13, '13', 0, 1, 0, 1741509435727, 1741509435727),
  ('房车水电桩', '全国充电桩实时地图', 32, '32', 0, 1, 1, 1741509435728, 1741509435728),
  ('航司羊毛党', 'BUG机票预警信息群', 35, '35', 0, 1, 2, 1741509435729, 1741509435729),
  ('旅拍穿搭志', '『出片率max的旅行穿搭』', 20, '20', 0, 1, 0, 1741509435730, 1741509435730),
  ('宠物旅行记', '『带毛孩子出游指南』', 37, '37', 0, 1, 1, 1741509435731, 1741509435731),
  ('火车漫游家', '『全国观光列车时刻表』', 16, '16', 0, 1, 2, 1741509435732, 1741509435732),
  ('户外安全课', '『野外急救知识培训』', 39, '39', 0, 1, 0, 1741509435733, 1741509435733),
  ('旅图交换站', '『明信片全球互寄计划』', 26, '26', 0, 1, 1, 1741509435734, 1741509435734),
  ('方言课堂', '『旅行常用方言速成』', 34, '34', 0, 1, 2, 1741509435735, 1741509435735),
  ('古迹修复志', '『敦煌壁画修复体验』', 21, '21', 0, 1, 0, 1741509435736, 1741509435736),
  ('地球酒馆', '『全球精酿啤酒地图』', 7, '7', 0, 1, 1, 1741509435737, 1741509435737),
  ('旅居植物园', '『多肉植物跨省托运』', 5, '5', 0, 1, 2, 1741509435738, 1741509435738),
  ('秘境方言', '『少数民族语言学习』', 10, '10', 0, 1, 0, 1741509435739, 1741509435739),
  ('旅行vlog课', '『运镜剪辑技巧教学』', 19, '19', 0, 1, 1, 1741509435740, 1741509435740),
  ('漂流笔记本', '『全球旅行者故事接龙』', 28, '28', 0, 1, 2, 1741509435741, 1741509435741),
  ('非遗美食团', '『跟着舌尖去旅行』', 14, '14', 0, 1, 0, 1741509435742, 1741509435742),
  ('星空观测组', '『最佳观星点推荐』', 31, '31', 0, 1, 1, 1741509435743, 1741509435743),
  ('旅居医疗站', '『高原反应预防指南』', 9, '9', 0, 1, 2, 1741509435744, 1741509435744),
  ('旅行书籍社', '『Lonely Planet共读』', 23, '23', 0, 1, 0, 1741509435745, 1741509435745),
  ('铁路迷之家', '『全国特色火车站打卡』', 17, '17', 0, 1, 1, 1741509435746, 1741509435746),
  ('机场过夜组', '『全球机场休息室评测』', 35, '35', 0, 1, 2, 1741509435747, 1741509435747),
  ('旅行冷知识', '『各国奇怪法律科普』', 12, '12', 0, 1, 0, 1741509435748, 1741509435748);